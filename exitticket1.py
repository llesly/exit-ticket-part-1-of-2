...
message = f"My favorite song from the playlist is {'Headshots'}."
print(message)
...
print("My favorite song is " + favorite_song + "by" + "Kali Uchis")
...
# message3 = 
# print(message3)
message3 = f"{'Kali Uchis'} sings that song"
print(message3)

# # # # Finding the length of a list via len()
# # # # How many songs are in your playlist? Write the number (integer) to create the variable songcount below: # songcount = len(playlist) 
# print(songcount)
...
print(f"\n{favorite_song} is a very good song!")
yay_song = "Yay Area"
playlist.remove(yay_song)
print(playlist)
